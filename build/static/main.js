...
function getLists() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch('http://localhost:3003/api/lists');
        const data = yield response.json(); // Parse lists
...
function createList(title) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield response.json(); // parse created list
        const newList = addListHTML(data.list);
        return newList;
    });
}
function addListHTML(listData) {
...
function addTaskHTML(taskData, ul) {
    const listId = ul.id;
    // Create a list item
    ...
    deleteButton.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        yield deleteTask(taskData._id, listId);
        //remove task element
        ul.removeChild(li);
    }));
...
function addTask(ul, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch(`http://localhost:3003/api/lists/${listId}/tasks`, {
            method: 'POST',
            headers: { 'Content-Type': "application/json" },
...
// Edit a task
function editTask(span, taskId, listId) {
    return __awaiter(this, void 0, void 0, function* () {
        const newText = prompt("Edit task:", span.textContent || "");
        if (newText !== null) {
            span.textContent = newText.trim() || span.textContent; // Update text if not empty
        }
        const response = yield fetch(`http://localhost:3003/api/lists/tasks`, {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
...
function deleteList(listElement) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch(`http://localhost:3003/api/lists/${listId}`, {
                method: "DELETE",
                headers: { "Content-Type": "application/json" },
            });
            if (!response.ok) {
